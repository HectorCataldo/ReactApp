...
export const Quotationlist = () => {
  ...
  if (!policy) {
    ...
    const columns = [
      ...
      { field: 'quotationnumber' ,headerName: 'Número de Póliza'   , width: 155, renderCell: (params) => ( <a href={`/Modifyquotation/${params.row.id}`} style={{ textDecoration: 'none' }}> {params.value} </a>) },
