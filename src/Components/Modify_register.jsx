...
export const Modify = (props) => {
  ...
  useEffect(() => {
    setFormData((prevData) => ({
      ...
      if (selectedClient) {
        ...
        if (selectedClient.profession) {
          setSelectedProfession({
            id_profession: selectedClient.profession.id_profession,
            profession_Name: selectedClient.profession.profession_Name
          });
        } else {
          setSelectedProfession(null); // O proporciona un valor por defecto adecuado
        }
      }
    }, [selectedClient]);
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.put(`http://localhost:8080/api/clients/${formData.id}`, {
                ...
                <Item md="12" className="Containers-Item">
                  ...
                  <Item className="group-form">
                    <TextField
                      ...
                      onChange={(e) => {
                        setDataClient({ ...dataClient, firstName: e.target.value });
                  ...
                  <Item className="group-form">
                    <TextField
                      ...
                      onChange={(e) => {
                        setDataClient((prevData) => ({ ...prevData, lastName: e.target.value }));
                  ...
                  <Item className="group-form">
                    <TextField
                      ...
                      name="secondLastName"
                      onChange={(e) => {
                        setDataClient((prevData) => ({ ...prevData, secondLastName: e.target.value }));
